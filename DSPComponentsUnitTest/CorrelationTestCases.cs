...
0.000000759473684f
            ...
            {
                Console.WriteLine(dc.OutputNonNormalizedCorrelation[i]+"    "+expectedOutput.Samples[i]);
            }
...
0.949263346546471f,
        ...
        public void CrossDirectNonNormalizedNonPeriodicCorrelationTestMethod1()
        {
            ...
            {
                Console.WriteLine(fc.OutputNonNormalizedCorrelation[i] + "    " + expectedOutput.Samples[i]);
            }
            Assert.IsTrue(UnitTestUtitlities.SignalsSamplesAreEqual(expectedOutput.Samples, fc.OutputNonNormalizedCorrelation));
        }
